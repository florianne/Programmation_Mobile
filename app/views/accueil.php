...
<!-- ---------------------------------------------- (Jusque ici) STRUCTURE DE LA PAGE IDENTIQUE ------------------------------------------------------------------------ -->				
				...
				<section class="col-md-7"> 	<!-- Espace centrale -->
					<div class="panel1 panel-default">
						<div class="panel-body">
							<h5><img src="img/B.png" class="imageflottante" alt="Image flottante" />ienvenu à vous chers internautes. Nous vous présentons LE site de référence pour les cinéastes ou amateurs de films 
							en tout genre.</br>Vous pouvez effectuer une recherche pour trouver directement le film que vous désirez ou bien accéder à la liste complète des films 
							disponibles sur ce site.</br></br>Pour bénéficier de plus d'options, veuillez vous inscrire. 
							Cela nous permettra, entre autre, de cibler les films qui vous plaisent et de vous proposer VOTRE liste favorite !</h5>
						</div>
					</div>
					<br>
					<div class="col-md-4 col-md-offset-4">
						<img src="img/bobine.jpg" class="img-rounded"></br>
					</div>
				</section>
				
<!-- ---------------------------------------------- (Depuis ici) STRUCTURE DE LA PAGE IDENTIQUE ------------------------------------------------------------------------ -->
