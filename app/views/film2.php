...
<!-- ---------------------------------------------- (Jusque ici) STRUCTURE DE LA PAGE IDENTIQUE ------------------------------------------------------------------------ -->								
				...
				<section class="col-md-7">		<!-- section centrale / contenu de la page -->
					...
					<h4>Seigneur des Anneaux</h4>		<!-- Titre du film -->
					</br>
					<img src="/img/separateur.png" class="img-rounded center-block">
					</br>
					<ul>		<!-- Information sur le film rempli avec la bdd -->
						<li><h6><strong>Réalisateur :</strong> Peter Jackson</h6></li>
						<li><h6><strong>Acteurs :</strong> Elijah Wood, Sean Astin, Ian McKellen</h6></li>
						<li><h6><strong>Durée :</strong> 2h45</h6></li>
						<li><h6><strong>Date de sortie :</strong> 19 Décembre 2001</h6></li>
						<li><h6><strong>Genre :</strong> Fantastique, Aventure, Action</h6></li>
						<li><h6><strong>Résumé :</strong> </h6><h5>Dans ce chapitre de la trilogie, le jeune et timide Hobbit, Frodon Sacquet, hérite d'un anneau. Bien loin d'être une simple babiole, il s'agit de l'Anneau Unique, un instrument de pouvoir absolu qui permettrait à Sauron, le Seigneur des ténèbres, de régner sur la Terre du Milieu et de réduire en esclavage ses peuples. À moins que Frodon, aidé d'une Compagnie constituée de Hobbits, d'Hommes, d'un Magicien, d'un Nain, et d'un Elfe, ne parvienne à emporter l'Anneau à travers la Terre du Milieu jusqu'à la Crevasse du Destin, lieu où il a été forgé, et à le détruire pour toujours. Un tel périple signifie s'aventurer très loin en Mordor, les terres du Seigneur des ténèbres, où est rassemblée son armée d'Orques maléfiques... La Compagnie doit non seulement combattre les forces extérieures du mal mais aussi les dissensions internes et l'influence corruptrice qu'exerce l'Anneau lui-même.
L'issue de l'histoire à venir est intimement liée au sort de la Compagnie. </h5></li>
					</ul>
					</br>
					<img src="/img/separateur.png" class="img-rounded center-block">
					</br>
					...
					<div class="media col-lg-12"> <!-- Bande annonce du film -->
						<div class="center">
							<iframe src="https://www.youtube.com/embed/hZlx0nt8bYk" width="630" height="520"></iframe>
						</div> 
					</div>
				</section>
